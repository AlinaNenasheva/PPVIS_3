...
public class MainWindow {
	...
	public MainWindow() {
		...
		firstPage.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				List<Point> points = extractBlock();
	...
	private void inputBtnShell(GridLayout gridLayout) {
		...
		inputOkButton.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				if (!inputBottomBordText.getText().isEmpty() && !inputTopBordText.getText().isEmpty()
						&& !enterAText.getText().isEmpty() && !enterBText.getText().isEmpty()
						&& !enterCText.getText().isEmpty()) {
					xMin = (Integer.parseInt(inputBottomBordText.getText()));
					xMax = Integer.parseInt(inputTopBordText.getText());
					int a = Integer.parseInt(enterAText.getText()), b = Integer.parseInt(enterBText.getText()),
	...
	public List<Point> extractBlock() {
		...
		if (x > 10) {
			List<Point> temporary = new ArrayList<>();
			int counter = 0;
	...
	public void updateShellA(int index) {
		Point showingPoint = controller.getPointFromGraphicA(index);
	...
	public void updateShellB(int index) {
		Point showingPoint = controller.getPointFromGraphicB(index);
		if (showingPoint == null)
			return;
